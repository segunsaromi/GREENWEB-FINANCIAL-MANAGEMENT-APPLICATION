...
if($_SESSION['db_type'] == 2) $fileSQL = 'database/greenweb_test.sql';
else $fileSQL = 'database/greenweb_fresh.sql';
...
<html>
	<?PHP includeHead('CTS Software', 0) ?>
		<meta http-equiv="refresh" content="<?PHP echo ($maxRuntime+1); ?>">
		<link rel="stylesheet" type="text/css" href="css/setup.css" />
	</head>
	<body>
		<div class="content_center">
			<img src="ico/greenweb_l.png" style="width:380px; margin-top:3em; margin-bottom:2em;"/>
			<p class="heading">Greenweb Setup Assistant</p>
			<div class="setup">
				<p>Database Import</p>
				<div class="progress">
